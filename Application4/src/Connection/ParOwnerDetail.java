...
public class ParOwnerDetail {
    ...
    public ParOwnerDetail(StringProperty userName, StringProperty firstName, StringProperty lastName, StringProperty CNIC, StringProperty dateOfBirth, StringProperty address, StringProperty status, StringProperty province, StringProperty tehsil, StringProperty district, StringProperty area, StringProperty phoneNo, StringProperty emergencyPhoneNo, StringProperty gender, StringProperty fatherName, StringProperty fatherCNIC) {
        UserName = userName;
        FirstName = firstName;
        LastName = lastName;
        this.CNIC = CNIC;
